...
class EncryptionApp {
    ...
    async handleEncrypt() {
        try {
            ...
            const encrypted = await cryptoEngine.encrypt(text, this.currentMethod, key, shift);
    ...
    async handleDecrypt() {
        try {
            ...
            const decrypted = await cryptoEngine.decrypt(text, this.currentMethod, key, shift);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('%c🔐 Text Encryptor', 'font-size: 20px; font-weight: bold; color: #6366f1;');
